  ...
  <table class="table" >
    <tbody>
      <tr>
        ...
        <td><input type="text" id="pname" name="Plant_name" class="form-control" required=""></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td><input type="text" id="pdesc" name="Plant_description" class="form-control" required=""></td>
      </tr>
      <tr>
        <th scope="row"style="color: green;"><label for="pdesc">Plant_height:</label ></th>
        <td><input type="text" id="pdesc" name="Plant_height" class="form-control" required=""></td>
      </tr>
      <tr>
        <th scope="row"style="color: green;"><label for="pdesc">Common name:</label></th>
        <td><input type="text" id="pdesc" name="Common_name" class="form-control" required=""></td>
      </tr>
      <tr>
        <th scope="row"style="color: green;"><label for="pdesc">Bloom time:</label></th>
        <td><input type="text" id="pdesc" name="Bloom_time" class="form-control" placeholder="Type something" required=""></td>
      </tr>
      <tr>
        <th scope="row"style="color: green;"><label for="pdesc">Flower colour:</label></th>
        <td><input type="text" id="pdesc" name="Flower_colour" class="form-control" placeholder="Type something" required=""></td>
      </tr>
      <tr>
        <th scope="row"style="color: green;"><label for="pdesc">Planting and care:</label></th>
        <td><input type="text" id="pdesc" name="Planting_care" class="form-control" required=""></td>
      </tr>

      <tr>
        <th scope="row"style="color: green;"><label for="pamt">Plant_amount:</label></th>
        <td><input type="number" id="pamt" name="Plant_amount" class="form-control" required=""></td>
      </tr>
      <tr>
