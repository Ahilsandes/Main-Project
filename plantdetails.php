...
?>
<input type="hidden" name="pid" value="<?php echo $row['Plant_id']; ?>">
<input type="hidden" name="pid" value="<?php echo $row['Plant_amount']; ?>">
                ...
                <div class="row justify-content-between">
                            ...
                            <div id="product_details_slider" class="carousel slide" data-ride="carousel">
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        ...
                                        <img src="<?php echo 'uploads/'.$row['Image1']; ?>" >
                    ...
                    <div class="col-12 col-md-6">
                        <div class="single_product_desc">
                            <h4 class="title"><?php echo $row['Plant_name']; ?></h4>
                            <h4 class="price"><?php echo " ".$row['Plant_amount']." /-"; ?></h4>
                            ...
                            <div class="cart--area d-flex flex-wrap align-items-center">
                                ...
                                <form class="cart clearfix d-flex align-items-center" method="post" action="addtocart.php">
                                    <!-- <div class="quantity">
                                     ...
                                     <a href="addtocart.php?id=<?php echo $row['Plant_id']; ?>" class="btn alazea-btn ml-15">Add to cart</a>
                            ...
                            <div class="products--meta">
                                ...
                                <p><span>Plant description:</span> <span><?php echo $row['Plant_description']; ?></span></p>
                                <p><span>Plant Height:</span> <span><?php echo  $row['Plant_height']; ?></span></p>
                                <p><span>Plant common name:</span> <span><?php echo $row['Common_name']; ?> </span></p>
                                   <p><span>Bloom time:</span> <span><?php echo $row['Bloom_time']; ?> </span></p>
                                      <p><span>Flower color:</span> <span><?php echo $row['Flower_colour']; ?> </span></p>
                                         <p><span>Planting Care:</span> <span><?php echo $row['Planting_care'];?> </span></p>
