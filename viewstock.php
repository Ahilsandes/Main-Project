...
<div class="container" style="text-align: center; padding-left:400px; color:black">
  <?php
  $con=mysqli_connect("localhost","root","","rosegardens") or die("couldnt connect to the server");
  $sql1="select Plant_name, quantity from `tbl_Plant` p, `tbl_quantity` q where p.Plant_id= q.Plant_id ";
  $res1=mysqli_query($con,$sql1);
  echo "<table class='table table-responsive text-center' id='tbl' class='table' style='display:block;'>";
  echo "<tr>";
  ...
  {
  echo"<tr>";
  echo"<td>",$row['Plant_name'],"</td><td>&nbsp;",$row['quantity'];
  echo"</tr>";
  ...
  <div>
  <a href="addquantity.php" class="button"> UPDATE STOCK</a>
</div>
