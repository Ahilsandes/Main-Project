...
$id=$_GET['id'];
echo $id;
$q2="SELECT * FROM `tbl_plant` WHERE `Plant_id`=$id";
$result=mysqli_query($con,$q2);
while ($row = mysqli_fetch_array($result)){
?>
  <form enctype="multipart/form-data" action="editplant_processing.php" method="post" class="container">
  ...
  <table class="table" >
    <tbody>
      <tr>
        ...
        <td><input type="text" id="pname" name="Plant_name" class="form-control" required="" value="<?php echo $row['Plant_name']; ?>" ></td>
      </tr>
      <tr>
        <th scope="row" style="color: green;"><label for="pcat">Plant_category:</label></th>
        <td>
          <select name="Plant_category" class="form-control" required="">
      ...
      <tr>
        ...
        <td><input type="text" id="pdesc" name="Plant_description" required="" class="form-control" value="<?php echo $row['Plant_description']; ?>"></td>
      </tr>
      <tr>
        <th scope="row"style="color: green;"><label for="pdesc">Plant_height:</label></th>
        <td><input type="text" id="pdesc" name="Plant_height" required="" class="form-control" value="<?php echo $row['Plant_height']; ?>"></td>
      </tr>
      <tr>
        <th scope="row"style="color: green;"><label for="pdesc">Common name:</label></th>
        <td><input type="text" id="pdesc" name="Common_name" required="" class="form-control" value="<?php echo $row['Common_name']; ?>"></td>
      </tr>
      <tr>
        <th scope="row"style="color: green;"><label for="pdesc">Bloom time:</label></th>
        <td><input type="text" id="pdesc" name="Bloom_time" required="" class="form-control" placeholder="Type something" value="<?php echo $row['Bloom_time']; ?>"></td>
      </tr>
      <tr>
        <th scope="row"style="color: green;"><label for="pdesc">Flower colour:</label></th>
        <td><input type="text" id="pdesc" required="" name="Flower_colour" class="form-control" placeholder="Type something" value="<?php echo $row['Flower_colour']; ?>"></td>
      </tr>
      <tr>
        <th scope="row"style="color: green;"><label for="pdesc">Planting and care:</label></th>
        <td><input type="text" id="pdesc" required="" name="Planting_care" class="form-control" value="<?php echo $row['Planting_care']; ?>"></td>
      </tr>

      <tr>
        <th scope="row"style="color: green;"><label for="pamt">Plant_amount:</label></th>
        <td><input type="number" id="pamt" required="" name="Plant_amount" class="form-control" value="<?php echo $row['Plant_amount']; ?>"></td>
      </tr>
      <tr>
