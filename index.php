...
<body>
    ...
    <!-- ##### Hero Area Start ##### -->
    <section class=	"hero-area" style="background-image: url(img/bg-img/24.jpg);">
...
?>
     ...
     <section class="new-arrivals-products-area bg-gray section-padding-50" style="padding-bottom: 150px;">
        <div class="container">
